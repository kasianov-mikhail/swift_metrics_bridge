...
Flutter bridge to Apple's [swift-metrics](https://github.com/apple/swift-metrics) framework.
...
Each metric instance maps to a corresponding swift-metrics type on iOS via method channels. By default, swift-metrics uses a no-op backend. To persist metrics, configure a swift-metrics backend (e.g., [Scout](https://github.com/kasianov-mikhail/scout)) on the iOS side.
